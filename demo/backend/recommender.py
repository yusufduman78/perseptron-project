...
FULL_RANKING_DIR = PROJECT_DIR / ".kaggle_outputs" / "full" / "05-ranking"
FULL_EXPLAINABILITY_DIR = PROJECT_DIR / ".kaggle_outputs" / "full" / "06-explainability"
V2_MODEL_DIR = FULL_RANKING_DIR / "models" / "proposal_v2"
V2_REPORT_DIR = FULL_RANKING_DIR / "reports" / "proposal_v2"
V2_EXPLAIN_REPORT_DIR = FULL_EXPLAINABILITY_DIR / "reports" / "proposal_v2"
V2_EXPLAIN_MODEL_DIR = FULL_EXPLAINABILITY_DIR / "models" / "proposal_v2"
...
TABULAR_MODEL_PATH = V2_MODEL_DIR / "tabular_only_fold0.pt"
IMAGE_MODEL_PATH = V2_MODEL_DIR / "image_history_fold0.pt"
FUSION_MODEL_PATH = V2_MODEL_DIR / "late_fusion_fold0.pt"
CNN_MODEL_PATH = V2_EXPLAIN_MODEL_DIR / "image_only_effnet_cnn_fold0.pt"

CLASSIFICATION_METRICS_PATH = V2_REPORT_DIR / "proposal_v2_classification_metrics.csv"
RANKING_METRICS_PATH = V2_REPORT_DIR / "proposal_v2_ranking_metrics.csv"
RANKING_SUMMARY_PATH = V2_REPORT_DIR / "proposal_v2_cv_summary.md"
CNN_METRICS_PATH = V2_EXPLAIN_REPORT_DIR / "proposal_v2_cnn_metrics.csv"
SHAP_SUMMARY_PATH = V2_EXPLAIN_REPORT_DIR / "proposal_v2_shap_summary.csv"
GRADCAM_DIR = V2_EXPLAIN_REPORT_DIR / "gradcam_examples"
