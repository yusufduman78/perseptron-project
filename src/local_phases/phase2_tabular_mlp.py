...
MODEL_OUTPUT_PATH = MODELS_DIR / "tabular_mlp.pt"
...
def load_dataset() -> pd.DataFrame:
    print("Loading sandbox CSV files...")
    ...
    print("Merging customer and article metadata...")
    data = model_data.merge(customers, on="customer_id", how="left")
